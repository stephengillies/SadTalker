...
def sadtalker_demo(checkpoint_path='checkpoints', config_path='src/config', warpfn=None):
    ...
    with gr.Blocks(analytics_enabled=False) as sadtalker_interface:
        gr.Markdown(
            "<div align='center'> <h2> 😭 SadTalker: Learning Realistic 3D Motion Coefficients "
            "for Stylized Audio-Driven Single Image Talking Face Animation (CVPR 2023) </h2> "
                ...
                with gr.Tabs(elem_id="sadtalker_checkbox"):
                    with gr.TabItem('Settings'):
                        gr.Markdown(
                            ...
                            "[best practice page](https://github.com/OpenTalker/SadTalker/blob/main/docs/best_practice.md) "
                            "for more detials"
                        )
                        with gr.Column(variant='panel'):
